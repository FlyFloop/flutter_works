...
class _SignupFormState extends State<SignupForm> {
  ...
  @override
  void initState() {
    signupBloc = BlocProvider.of<BlocSignupBloc>(context);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<BlocSignupBloc, SignupState>(
    ...
    }, child: BlocBuilder<BlocSignupBloc, SignupState>(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () async => isSignupButtonEnabled(signupState)
