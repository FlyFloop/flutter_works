/*
Firebasede koleksiyonlara CollectionReference ile ulaşılıyor 
Dökümanlara ise DocumentReference ile ulaşılıyor
...
void main() async {
  /*
  daha uygulama çizilmeden firebase başlatmış oluyoruz çünkü uyglama başlamadan
  veritabanından veri çekmek gerekebilir
  */
  WidgetsFlutterBinding.ensureInitialized();
  //await Firebase.initializeApp(); //firebase başlatıldı
  runApp(MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: FutureBuilder(
          future: _initialization, //bitmesini beklicek
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              //gelen veride hata var ise
              return Center(
                child: Text('snapshotda hata oluştu'),
              );
            } else if (snapshot.hasData) {
              //veri geldiyse
              return MyHomePage(title: 'Flutter Demo Home Page');
            } else {
              //hala verinin gelmesi bekleniyorsa
              return Center(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    FirebaseFirestore firestore = FirebaseFirestore
        .instance; //database için işlem yapmama olanak sağlıyor
    CollectionReference testCollectionRef = FirebaseFirestore.instance
        .collection('testCollection'); //db için referans oluşturduk
                  ...
                  return Flexible(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Text('${listOfDocuments[index].data()}');
                      },
                    ),
                  );
                },
